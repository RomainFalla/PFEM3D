...
inline Eigen::MatrixXd SolverIncompressible::getB(std::size_t elementIndex) const
{
...
inline std::vector<Eigen::MatrixXd> SolverIncompressible::getN() const
{
...
inline Eigen::VectorXd SolverIncompressible::getQFromNodesStates(unsigned short beginState, unsigned short endState) const
{
