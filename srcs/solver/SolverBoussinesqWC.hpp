#pragma once
#ifndef SOLVERBOUSSINESQWC_HPP_INCLUDED
#define SOLVERBOUSSINESQWC_HPP_INCLUDED

#include "Solver.hpp"

struct SolverBoussinesqWCCreateInfo
{
    double rho0 = 0;
    double mu = 0;
    double K0 = 0;
...
/**
 * \class SolverBoussinesqWC
 * \brief Represents a solver for an compressible Newtonian fluid.
 */
class SOLVER_API SolverBoussinesqWC : public Solver
{
    public:
        SolverBoussinesqWC()                                                        = delete;
        SolverBoussinesqWC(const SolverBoussinesqWCCreateInfo& solverBoussiWCInfos);
        SolverBoussinesqWC(const SolverBoussinesqWC& solverBoussinesqWC)            = delete;
        SolverBoussinesqWC& operator=(const SolverBoussinesqWC& solverBoussinesqWC) = delete;
        SolverBoussinesqWC(SolverBoussinesqWC&& solverBoussinesqWC)                 = delete;
        SolverBoussinesqWC& operator=(SolverBoussinesqWC&& solverBoussinesqWC)      = delete;
    ...
    private:
         ...
         * \param F A reference to the vector F.
         */
        void applyBoundaryConditionsHeat(Eigen::DiagonalMatrix<double,Eigen::Dynamic>& invMheat, Eigen::VectorXd& Fheat);
         ...
         * \param F A reference to the vector F.
         */
        void buildMatricesHeat(Eigen::DiagonalMatrix<double,Eigen::Dynamic>& invMheat, Eigen::VectorXd& Fheat);
...
#include "SolverBoussinesqWC.inl"

#endif // SOLVERBOUSSINESQWC_HPP_INCLUDED
